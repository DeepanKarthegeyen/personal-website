  ...
  return (
    <div id="hero" className="text-center" style={{ marginTop: 0, paddingTop: 0, marginBottom: 24 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', fontSize: '2rem', marginBottom: 0 }}>
        <a href="mailto:deepan_31@yahoo.co.in" className="hero-social-icon hover-highlight" title="Mail"><FaEnvelope /></a>
        <a href="https://www.linkedin.com/in/deepankarthegeyen" target="_blank" rel="noopener noreferrer" className="hero-social-icon hover-highlight" title="LinkedIn"><FaLinkedin /></a>
        <a href="mailto:deepan_31@gmail.com" className="hero-social-icon hover-highlight" title="Gmail"><SiGmail /></a>
      </div>
      <br />
      <a
        href="#projects"
